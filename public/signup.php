		...
		<div class="col-10 col-lg-3 mx-auto">
			...
			if (isset($_GET["error"])) {
				if ($_GET["error"] == "invaliduid"){
					print("<p><strong>Choose a proper username!</strong></p>");
				}
				else if ($_GET["error"] == "invalidemail"){
					print("<p><strong>Choose a proper email!</strong></p>");
				}
				else if ($_GET["error"] == "passwordsdontmatch"){
					print("<p><strong>Passwords doesn"t match!</strong></p>");
				}
				else if ($_GET["error"] == "usernametaken"){
					print("<p><strong>This username is already associated with an existing account!</strong></p>");
				} 
				else if ($_GET["error"] == "emailwasused"){
					print("<p><strong>This email address is already associated with an existing account!</strong></p>");
				}
				else if ($_GET["error"] == "stmtfaild"){
					print("<p><strong>Somethink went wrong, try again!</strong></p>");
				}
				else if ($_GET["error"] == "none"){
					print("<p><strong>You have signed up!</strong></p>");
				}
			}
			?>
