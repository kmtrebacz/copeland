...
if ($_SERVER["REQUEST_METHOD"] == "GET") 
{
	$getListId = $_GET["list_id"];
     ...
     $listInfoDbResult = dbQuery("SELECT lists.list_id, lists.list_name, lists.is_public FROM lists WHERE lists.list_id = ?", [$getListId], true);
	...
	print($template->render([
          ...
          "listId"      => $listInfoDbResult["list_id"],
