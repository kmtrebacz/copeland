     ...
     <div class="container">
          <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
               ...
               <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
                    ...
                    <li><a href="./items/items.php" class="nav-link px-3 link-dark">ITEMS</a></li>
                    <li><a href="./lists/create_list.php" class="nav-link px-3 link-dark">NEW SET</a></li>
               ...
               <div class="text-end">
                    <a href="./login/login.php" class="btn btn-outline-primary me-2" href="">Login</a>
